...
define("src/EnvelopeCreator", ["require", "exports", "@microsoft/applicationinsights-common", "@microsoft/applicationinsights-core-js"], function (require, exports, applicationinsights_common_2, applicationinsights_core_js_2) {
    ...
    var EnvelopeCreator = /** @class */ (function () {
        ...
        EnvelopeCreator.extractPartAExtensions = function (item, env) {
            ...
            if (item.tags[applicationinsights_common_2.UnmappedKeys.applicationVersion]) {
                ...
                tagKeysfound.push(applicationinsights_common_2.UnmappedKeys.applicationVersion);
            }
            ...
            if (item.tags[applicationinsights_common_2.CtxTagKeys.sessionIsFirst]) {
                ...
                tagKeysfound.push(applicationinsights_common_2.CtxTagKeys.sessionIsFirst);
            }
            if (item.ctx[applicationinsights_common_2.DeviceExtensionKeys.localId]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.deviceId] = item.ctx[applicationinsights_common_2.DeviceExtensionKeys.localId];
                keysFound.push(applicationinsights_common_2.DeviceExtensionKeys.localId);
            }
            if (item.ctx[applicationinsights_common_2.IngestExtKeys.clientIp]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.deviceIp] = item.ctx[applicationinsights_common_2.IngestExtKeys.clientIp];
                tagKeysfound.push(applicationinsights_common_2.IngestExtKeys.clientIp);
            }
            if (item.ctx[applicationinsights_common_2.WebExtensionKeys.browserLang]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.deviceLanguage] = item.ctx[applicationinsights_common_2.WebExtensionKeys.browserLang];
                keysFound.push(applicationinsights_common_2.WebExtensionKeys.browserLang);
            }
            if (item.tags[applicationinsights_common_2.UnmappedKeys.deviceLocale]) {
                ...
                tagKeysfound.push(applicationinsights_common_2.UnmappedKeys.deviceLocale);
            }
            if (item.ctx[applicationinsights_common_2.DeviceExtensionKeys.model]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.deviceModel] = item.ctx[applicationinsights_common_2.DeviceExtensionKeys.model];
                keysFound.push(applicationinsights_common_2.DeviceExtensionKeys.model);
            }
            if (item.ctx[applicationinsights_common_2.UnmappedKeys.deviceNetwork]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.deviceNetwork] = item.ctx[applicationinsights_common_2.UnmappedKeys.deviceNetwork];
                keysFound.push(applicationinsights_common_2.UnmappedKeys.deviceNetwork);
            }
            if (item.ctx[applicationinsights_common_2.UnmappedKeys.deviceOEMName]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.deviceOEMName] = item.ctx[applicationinsights_common_2.UnmappedKeys.deviceOEMName];
                keysFound.push(applicationinsights_common_2.UnmappedKeys.deviceOSVersion);
            }
            if (item.tags[applicationinsights_common_2.UnmappedKeys.deviceOSVersion]) {
                ...
                tagKeysfound.push(applicationinsights_common_2.UnmappedKeys.deviceOSVersion);
            }
            if (item.ctx[applicationinsights_common_2.OSExtKeys.deviceOS]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.deviceOS] = item.ctx[applicationinsights_common_2.OSExtKeys.deviceOS];
                keysFound.push(applicationinsights_common_2.OSExtKeys.deviceOS);
            }
            if (item.ctx[applicationinsights_common_2.UnmappedKeys.deviceNetwork]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.deviceNetwork] = item.ctx[applicationinsights_common_2.UnmappedKeys.deviceNetwork];
                keysFound.push(applicationinsights_common_2.UnmappedKeys.deviceNetwork);
            }
            if (item.ctx[applicationinsights_common_2.DeviceExtensionKeys.deviceType]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.deviceType] = item.ctx[applicationinsights_common_2.DeviceExtensionKeys.deviceType];
                keysFound.push(applicationinsights_common_2.DeviceExtensionKeys.deviceType);
            }
            if (item.tags[applicationinsights_common_2.UnmappedKeys.deviceOSVersion]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.deviceOSVersion] = item.tags[applicationinsights_common_2.UnmappedKeys.deviceOSVersion];
                tagKeysfound.push(applicationinsights_common_2.UnmappedKeys.deviceOSVersion);
            }
            if (item.tags[applicationinsights_common_2.WebExtensionKeys.screenRes]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.deviceScreenResolution] = item.tags[applicationinsights_common_2.WebExtensionKeys.screenRes];
                tagKeysfound.push(applicationinsights_common_2.WebExtensionKeys.screenRes);
            }
            if (item.tags[applicationinsights_common_2.SampleRate]) {
                ...
                tagKeysfound.push(applicationinsights_common_2.SampleRate);
            }
            if (item.tags[applicationinsights_common_2.CtxTagKeys.locationIp]) {
                ...
                tagKeysfound.push(applicationinsights_common_2.CtxTagKeys.locationIp);
            }
            if (item.tags[applicationinsights_common_2.CtxTagKeys.internalSdkVersion]) {
                ...
                tagKeysfound.push(applicationinsights_common_2.CtxTagKeys.internalSdkVersion);
            }
            if (item.tags[applicationinsights_common_2.CtxTagKeys.internalAgentVersion]) {
                ...
                tagKeysfound.push(applicationinsights_common_2.CtxTagKeys.internalAgentVersion);
            }
            if (item.tags[applicationinsights_common_2.CtxTagKeys.operationRootId]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.operationRootId] = item.tags[applicationinsights_common_2.CtxTagKeys.operationRootId];
                tagKeysfound.push(applicationinsights_common_2.CtxTagKeys.operationRootId);
            }
            if (item.tags[applicationinsights_common_2.CtxTagKeys.operationSyntheticSource]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.operationSyntheticSource] = item.tags[applicationinsights_common_2.CtxTagKeys.operationSyntheticSource];
                tagKeysfound.push(applicationinsights_common_2.CtxTagKeys.operationSyntheticSource);
            }
            if (item.tags[applicationinsights_common_2.CtxTagKeys.operationParentId]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.operationParentId] = item.tags[applicationinsights_common_2.CtxTagKeys.operationParentId];
                tagKeysfound.push(applicationinsights_common_2.CtxTagKeys.operationParentId);
            }
            if (item.tags[applicationinsights_common_2.CtxTagKeys.operationName]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.operationName] = item.tags[applicationinsights_common_2.CtxTagKeys.operationName];
                tagKeysfound.push(applicationinsights_common_2.CtxTagKeys.operationName);
            }
            if (item.tags[applicationinsights_common_2.CtxTagKeys.operationId]) {
                env.tags[applicationinsights_common_2.CtxTagKeys.operationId] = item.tags[applicationinsights_common_2.CtxTagKeys.operationId];
                tagKeysfound.push(applicationinsights_common_2.CtxTagKeys.operationId);
            }
    ...
    var DependencyEnvelopeCreator = /** @class */ (function (_super) {
        ...
        DependencyEnvelopeCreator.prototype.Create = function (logger, telemetryItem) {
            ...
            var method = bd.properties ? bd.properties[applicationinsights_common_2.HttpMethod] : "GET";
