...
define("EnvelopeCreator", ["require", "exports", "applicationinsights-common", "applicationinsights-core-js"], function (require, exports, applicationinsights_common_2, applicationinsights_core_js_2) {
    ...
    var PageViewEnvelopeCreator = /** @class */ (function (_super) {
        ...
        PageViewEnvelopeCreator.prototype.Create = function (logger, telemetryItem) {
            ...
            if (!applicationinsights_core_js_2.CoreUtils.isNullOrUndefined(telemetryItem.baseData.pageType)) {
                customProperties["pageType"] = telemetryItem.baseData.pageType;
            }
            // isLoggedIn is a field that Breeze still does not recognize as part of Part B. For now, put it in Part C until it supports it as a domain property
            if (!applicationinsights_core_js_2.CoreUtils.isNullOrUndefined(telemetryItem.baseData.isLoggedIn)) {
                customProperties["isLoggedIn"] = telemetryItem.baseData.isLoggedIn;
            }
            // pageTags is a field that Breeze still does not recognize as part of Part B. For now, put it in Part C until it supports it as a domain property
            if (!applicationinsights_core_js_2.CoreUtils.isNullOrUndefined(telemetryItem.baseData.pageTags)) {
    ...
    var PageViewPerformanceEnvelopeCreator = /** @class */ (function (_super) {
        ...
        PageViewPerformanceEnvelopeCreator.prototype.Create = function (logger, telemetryItem) {
            ...
            var baseData = new applicationinsights_common_2.PageViewPerformance(logger, name, url, duration, customProperties, customMeasurements);
    ...
    var TraceEnvelopeCreator = /** @class */ (function (_super) {
        ...
        TraceEnvelopeCreator.prototype.Create = function (logger, telemetryItem) {
            ...
            var severityLevel = telemetryItem.baseData.severityLevel;
            var customProperties = EnvelopeCreator.extractProperties(telemetryItem.data);
            var baseData = new applicationinsights_common_2.Trace(logger, message, customProperties, severityLevel);
        ...
        SenderTests.prototype.registerTests = function () {
            ...
            this.testCase({
                ...
                test: function () {
                    ...
                    var appInsightsEnvelope = _this._sender._constructEnvelope(inputEnvelope);
